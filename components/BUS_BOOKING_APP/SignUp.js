    ...
    return (
        <View style={styles.container}>
            <ImageBackground source={{ uri: 'https://img.freepik.com/free-vector/hand-painted-watercolor-pastel-sky-background_23-2148902771.jpg?auto=format&h=200' }}
                ...
                <Text style={styles.Text_1}>SignUp</Text>
                <Text style={styles.Text_2}>Already have an account? </Text><TouchableOpacity><Text style={{ fontSize: 20, color: 'red', textAlign: 'right', marginRight: 30, }}>Login</Text></TouchableOpacity>
                <View>
                    <TextInput
                ...
                <Text style={{ marginLeft: 20, color: '#000', fontSize: 18, fontWeight: '650' }}>Open with</Text>
